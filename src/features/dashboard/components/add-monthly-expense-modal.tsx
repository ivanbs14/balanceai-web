              ...
              <div className="sm:col-span-2">
                ...
                <FieldShell>
                  <select
                    ...
                    className="h-9 w-full appearance-none rounded-[0.55rem] border-0 bg-transparent px-2 pr-7 text-[0.74rem] text-foreground outline-none disabled:text-[#8b8b98] sm:h-14 sm:px-4 sm:pr-12 sm:text-[1.05rem]"
                  >
                    {isLoadingCards ? (
                ...
                {cardsErrorMessage ? (
                  <p className="mt-1 text-[0.78rem] text-[#9a3b65] sm:mt-2 sm:text-sm">{cardsErrorMessage}</p>
                ) : null}
                {!isLoadingCards && !cardsErrorMessage && cards.length === 0 ? (
                  <p className="mt-1 text-[0.78rem] text-[#9a3b65] sm:mt-2 sm:text-sm">
