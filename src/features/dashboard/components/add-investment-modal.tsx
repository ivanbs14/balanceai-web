...
function createInitialFormState(): InvestmentFormState {
  return {
    name: "",
...
function mapInvestmentMethodToApi(method: string): ApiTransationPaymentMethod {
  switch (method) {
    case "Pix":
      return "PIX";
    case "Transferencia":
...
function mapInvestmentCategoryToApi(category: string): ApiTransationCategory {
  switch (category) {
    case "Tesouro":
    case "Renda fixa":
    case "Acoes":
